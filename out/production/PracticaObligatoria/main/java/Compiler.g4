...
program :
   ...
   } dcllist J* funlist {sb.append($funlist.v + "<hr/><a id=\"Main\"><h2>Programa Principal</h2>");} J* sentlist <EOF>
   {
        sb.append($sentlist.v + "<a href=\"#Main\">Inicio del programa principal</a> "
